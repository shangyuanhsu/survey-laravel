        ...
        <PageComponent
            ...
            buttons={
                ...
                <div className="flex gap-2">
                    ...
                    <TButton color="red" onClick={handleDelete}>
                        ...
                        <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                            ...
                            <div>
                                ...
                                <div className="mt-1 flex items-center">
                                    ...
                                    <button
                                        type="button"
                                        className="relative ml-5 rounded-md border border-gray-300 bg-white py-2 px-3 text-sm font-medium leading-4 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                    >
                                        <input
                                            type="file"
                            ...
                            <div className="flex items-start">
                                <div className="flex h-5 items-center">
                                    <input
                                        ...
                                        className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 p-3"
                                    />
                                </div>
                            ...
                            {error.__html && (
                                <div className="bg-red-500 text-white py-2 px-3 rounded-lg" dangerouslySetInnerHTML={error}>
                                </div>)
                            }
                        </div>
